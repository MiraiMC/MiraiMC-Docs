...
export default defineConfig({
    ...
    head: [
        [
            'meta', { name: 'keywords', content: 'miraimc,mirai,miraibot,dreamvoid,mirai qq bot,mirai机器人,qq机器人,minecraft,bukkit,paper,folia,purpur,tuinity,leaves,服务端,我的世界,mc,我的世界服务器,我的世界服务端,服务端插件,插件,bukkit插件,paper插件,folia插件,qq' }
        ]
    ],
    lang: 'zh-Hans',
    lastUpdated: true,
    ...
    themeConfig: {
        ...
        nav: [
            { text: '主页', link: '/' },
            { text: '帮助手册', link: '/tutorial/server', activeMatch: '/.+' },
